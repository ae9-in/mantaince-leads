...
import { getCostConversions, createCostConversion, updateCostConversion, deleteCostConversion } from '../../../../server/src/controllers/costConversions.js';
...
describe('costConversionsController.getCostConversions', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('returns cost conversions successfully for vertical', async () => {
    const mockRows = [
    ...
    await getCostConversions(req, res);
  ...
  it('blocks agent from accessing cost conversions outside vertical access', async () => {
...
describe('costConversionsController.createCostConversion', () => {
  it('creates cost conversion and records audit log', async () => {
    ...
    await createCostConversion(req, res);
